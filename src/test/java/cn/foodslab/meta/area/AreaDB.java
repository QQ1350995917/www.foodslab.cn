...
////        aClass.newInstance();
////        String url="jdbc:mysql://localhost:3306/test?user=foodslab&password=foodslab";
////        Connection connection = DriverManager.getConnection(url);
////        Statement statement = connection.createStatement();
//
////        File fileIn = new File("/Users/dingpengwei/workspace/dingpw/www.foodslab.cn/src/test/resources/area/address.sql");
...
//         */
////        File fileIn = new File("/Users/dingpengwei/workspace/dingpw/www.foodslab.cn/src/test/resources/area/address.sql");
////        File fileOut = new File("/Users/dingpengwei/workspace/dingpw/www.foodslab.cn/src/test/resources/area/address1.sql");
////        BufferedReader bufferedReader = new BufferedReader(new FileReader(fileIn));
